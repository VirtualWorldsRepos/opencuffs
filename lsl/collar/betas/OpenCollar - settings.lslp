...
list g_lstKeep_on_Cleanup=["owner","secowners","openaccess","group","groupname","rlvon","locked","prefix"];
...
DumpCache()
{
    ...
    string out = "DB Settings Cache:";
    for (n = 0; n < stop; n = n + 2)
    {
        //handle strlength > 1024
        string add = llList2String(dbcache, n) + "=" + llList2String(dbcache, n + 1) + "\n";
