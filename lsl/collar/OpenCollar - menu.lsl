...
list menunames = ["Main", "Help/Debug", "Appearance"];
...
default
{
    state_entry()
    {
        ...
        //give the help menu a GIVECARD button
    ...
    {
        if (num >= COMMAND_OWNER && num <= COMMAND_WEARER && str == "menu")
        {
            //give id the main menu
            Menu("Main", id);
        }
        else if (str == "help" && num >= COMMAND_OWNER && num <=COMMAND_WEARER)
        {
